...
{{--                                <textarea name="number" class="form-control-lg" style="font-size:75px; font-size:75px;height: 151px;width: 100%"></textarea>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <input type="number" name="Receive" value="{{old('Receive')}}" class="form-control-lg" style="font-size:20px; width: 100%;border: 0.5px solid #d0d0d0;" placeholder="Receive Amount ">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
{{--                                <textarea name="number" value="{{old('number')}}" class="form-control-lg" style="font-size:75px; font-size:75px;height: 151px;width: 100%"></textarea>--}}
                        ...
                        <table class="table table-bordered" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>
                                    @if($bkash->Receive)
                                        @if($bkash->Receive==1)
                                            <a href="{{route('ReceiveBkash',$bkash->id)}}" class="btn btn-sm btn-danger">Not Receive ({{$bkash->amount}})</a>
                                        @elseif($bkash->Receive==2)
                                            {{$bkash->amount}}
                                        @endif
                                    @else
