                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('asset/img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('asset/img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('asset/img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('asset/img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
                                          ...
                                          <div class="timeline-desk">
                                              <div class="card">
                                                  <div class="card-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="{{asset('asset/img/sm-img-1.jpg')}}">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="{{asset('asset/img/sm-img-2.jpg')}}">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="{{asset('asset/img/sm-img-3.jpg')}}">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="{{asset('asset/img/sm-img-1.jpg')}}">
                                                          </a>
                      ...
                      <section class="card post-wrap pro-box">
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="card-body text-center">
                                  <div class="pro-thumb">
                                      <img src="{{asset('asset/img/ring.jpg')}}" alt="">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="card-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="{{asset('asset/img/follower-avatar.jpg')}}" alt="">
                                          </div>
                                      </div>
                                  </div>
      ...
      <div class="sb-slidebar sb-right sb-style-overlay">
          ...
          <ul class="quick-chat-list">
              <li class="online">
                  <div class="media">
                      <a href="#" class="">
                          <img alt="" src="{{asset('asset/img/chat-avatar2.jpg')}}" class="mr-3 rounded-circle">
                      </a>
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="">
                          <img alt="" src="{{asset('asset/img/chat-avatar.jpg')}}" class="mr-3 rounded-circle">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="">
                          <img alt="" src="{{asset('asset/img/pro-ac-1.png')}}" class="mr-3 rounded-circle">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="">
                          <img alt="" src="{{asset('asset/img/avatar1.jpg')}}" class="mr-3 rounded-circle">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="">
                          <img alt="" src="{{asset('asset/img/mail-avatar.jpg')}}" class="mr-3 rounded-circle">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
